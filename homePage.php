...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #7D7C7C;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <span class="nav-link active text-white">Welcome <?php echo $name;?></span>
                </li>
                <li class="nav-item">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <span class="material-symbols-outlined" id="fileInputTrigger" ><span style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal">manage_accounts </span></span>
